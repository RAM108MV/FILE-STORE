...
class Config(object):
	...
	API_HASH = os.environ.get("ba917e1a377fa4ea750d9253bcaf9940")
	BOT_TOKEN = os.environ.get("5962578351:AAE-LLipV42dg7peHi9JT6w82c11LxDXid0")
	BOT_USERNAME = os.environ.get("File_Forward01_Bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1001940024711"))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "1936430521"))
	DATABASE_URL = os.environ.get("mongodb+srv://Automedia:Automedia@cluster0.atmbq90.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001713726502")
